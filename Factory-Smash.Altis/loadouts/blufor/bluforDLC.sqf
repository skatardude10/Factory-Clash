...
_outfit = ["U_B_CombatUniform_mcam_worn","U_B_CombatUniform_mcam_tshirt","U_B_CTRG_1","U_B_CTRG_2","U_B_CTRG_3"] call BIS_fnc_selectRandom;
_vest = ["V_PlateCarrier1_rgr","V_PlateCarrierSpec_mtp","V_PlateCarrier1_blk","V_TacVest_blk","V_Chestrig_blk","V_TacVestIR_blk","V_Chestrig_rgr","V_TacVest_oli","V_PlateCarrier1_rgr"] call BIS_fnc_selectRandom;
_backpack = ["B_AssaultPack_mcamo","B_Kitbag_mcamo","B_Carryall_cbr","B_Kitbag_rgr","B_Kitbag_cbr"] call BIS_fnc_selectRandom;
_hat = ["H_Cap_tan_specops_US","H_Bandanna_mcamo","H_HelmetB_light","H_Cap_oli_hs","H_Beret_02","H_MilCap_gry","H_Cap_blu","H_Cap_police","H_Cap_tan_specops_US","H_MilCap_mcamo","H_Cap_headphones","H_Booniehat_mcamo","H_Booniehat_khk_hs","H_Cap_usblack"] call BIS_fnc_selectRandom;
