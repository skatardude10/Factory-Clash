...
_randomGunAndMagArray = gunAndMagArrayRocketeer select (floor (random (count gunAndMagArrayRocketeer)));
...
_randomLauncherAndMissileArray = _launcherAndMissileArray select 0;
...
_vest = ["V_PlateCarrierGL_blk","V_PlateCarrierSpec_blk"] call BIS_fnc_selectRandom;
_backpack = ["B_Carryall_oucamo","B_FieldPack_blk"] call BIS_fnc_selectRandom;
_hat = ["H_HelmetSpecO_blk"] call BIS_fnc_selectRandom;
